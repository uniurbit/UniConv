...
return [
    ...
    */
    'attributes' => [        
        ...
        'assigments.*.role'=>'Ruolo',
        'assigments.*.title'=>'Titolo',
        'assigments.*.istitute'=>'Istituto',
        'assigments.*.from'=>'Da',
        'assigments.*.to'=>'A',
        'assigments.*.document'=>'Documento',
        'assigments.*.path'=>'Percorso',
        ...
        'birthplace'=>'Città di nascita',
        'birthprovince'=>'Provincia di nascita',
        'birthdate'=>'Data di nascita',
        'com_res'=>'Comune di residenza',
        'prov_res'=>'Provincia di residenza',
        'via_res'=>'Via di residenza',
        'civ_res'=>'Civico',
        'presso'=>'Presso?',
    ],
