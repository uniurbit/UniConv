...
@Component({
  ...
  <div class="btn-toolbar mb-2" role="toolbar" *ngIf="!to.hidetoolbar">
    <div class="btn-group btn-group-sm">    
        <button type="button"class="btn btn-sm btn-primary rounded-lg" (click)="addFirst()"  >              
            <span class="oi oi-plus"></span>
            <span class="ml-2">Aggiungi</span>
        </button>    
        <button type="button" class="btn btn-sm btn-primary rounded-lg" [disabled]="to.selected.length == 0" (click)="removeSelected()"  >              
