...
@Component({
  ...
  template: `  
  <div class="mb-2">  
    <div *ngIf="to.label">{{to.label}} <span *ngIf="to.required && to.hideRequiredMarker !== true">*</span></div> 
...
export class RepeatTypeComponent extends FieldArrayType {
  constructor(private cd: ChangeDetectorRef, public confirmationDialogService: ConfirmationDialogService) {
    super();         
  }
  ...
  ngOnInit() {
    ...
    this.to.removeAll = this.clearFormArray.bind(this);
